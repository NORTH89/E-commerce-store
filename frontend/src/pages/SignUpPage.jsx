...
const SignUpPage = () => {
    ...
    return (
        <div className='flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
            ...
            >
                <h2 className='mt-6 text-center text-3xl font-extrabold text-[#6cd506]'>Create your account</h2>
            </motion.div>
            ...
            >
                <div className='bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10'>
                    <form onSubmit={handleSubmit} className='space-y-6'>
                        ...
                        <button
							...
							rounded-md shadow-sm text-sm font-medium text-white bg-gradient-to-r 
							 from-[#6cd506] to-emerald-700 hover:from-[#6dd506ab] hover:to-emerald-600
                    ...
                    <p className='mt-8 text-center text-sm text-gray-400'>
                        ...
                        <Link to='/login' className='font-medium text-[#6cd506] hover:text-[#6dd506d7]'>
